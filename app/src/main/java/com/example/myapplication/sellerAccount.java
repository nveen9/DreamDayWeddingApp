...
public class sellerAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StorageReference ImagesRefP1 = storageRef.child("photographer/" + userID+"/" + "package1");
        ...
        StorageReference ImagesRefP2 = storageRef.child("photographer/" + userID+"/" + "package2");
        ...
        StorageReference ImagesRefP3 = storageRef.child("photographer/" + userID+"/" + "package3");
        ...
        StorageReference ImagesRefW1 = storageRef.child("photographer/" + userID+"/" + "work1");
        ...
        StorageReference ImagesRefW2 = storageRef.child("photographer/" + userID+"/" + "work2");
        ...
        StorageReference ImagesRefW3 = storageRef.child("photographer/" + userID+"/" + "work3");
        ...
        StorageReference ImagesRefW4 = storageRef.child("photographer/" + userID+"/" + "work4");
        ...
        StorageReference ImagesRefW5 = storageRef.child("photographer/" + userID+"/" + "work5");
...
//        });
        ...
        pf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(sellerAccount.this, sellerProfileEdit.class);
        ...
        current.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ActivityCompat.checkSelfPermission(sellerAccount.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                    RealtimeLocation();
                } else {
                    ActivityCompat.requestPermissions(sellerAccount.this, new String[]
        ...
        different.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(sellerAccount.this, map.class);
                startActivity(intent);
                LocLayout.setVisibility(View.GONE);
            }
        });
...
//                startActivity(signInActivity);
                mAuth.signOut();
                Intent intent = new Intent(sellerAccount.this, Login.class);
                startActivity(intent);
            }
        });
    }
                ...
                re.child(uID).child("starting_Price").setValue(startPrc).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull @NotNull Task<Void> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(sellerAccount.this, "Price Updated", Toast.LENGTH_SHORT).show();
                        }
                        else {
                            Toast.makeText(sellerAccount.this, "Error when Update Price", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }catch (Exception e){
    ...
    private void RealtimeLocation() {
        ...
        fusedLocationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
            ...
            public void onComplete(@NonNull @NotNull Task<Location> task) {
                ...
                if (location != null) {
                    try {
                        Geocoder geocoder = new Geocoder(sellerAccount.this, Locale.getDefault());
                        ...
                        FirebaseDatabase.getInstance().getReference("Photography").child(userID).child("latitude").setValue(latitude);
                        FirebaseDatabase.getInstance().getReference("Photography").child(userID).child("longitude").setValue(longitude);
                        FirebaseDatabase.getInstance().getReference("Photography").child(userID).child("locality").setValue(locality);
                        if (locality==null){
                            FirebaseDatabase.getInstance().getReference("Photography").child(userID).child("locality").setValue("");
                        }else {
                            FirebaseDatabase.getInstance().getReference("Photography").child(userID).child("locality").setValue(locality);
                        }
                        FirebaseDatabase.getInstance().getReference("Photography").child(userID).child("address").setValue(address);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
    ...
    private void saveimgPckg1() {
        ...
        ImagesRefP1.putFile(imgUr).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ImagesRefP1.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        Toast.makeText(sellerAccount.this, "Image Uploaded Successfully", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onFailure(@NonNull @NotNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(sellerAccount.this, "Image Uploaded Unsuccessful", Toast.LENGTH_SHORT).show();
            }
