...
public class bDressMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bdress_main);
        ...
        DatabaseReference re = FirebaseDatabase.getInstance().getReference("bDress");
        ...
        hm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(bDressMain.this, firstHome.class);
        ...
        pf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(bDressMain.this, home.class);
                startActivity(intent);
            }
        });
        ...
        lo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mAuth.signOut();
                Intent intent = new Intent(bDressMain.this, Login.class);
                startActivity(intent);
            }
        });
        ...
        cll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Toast.makeText(bDressMain.this, "Invalid Number!", Toast.LENGTH_SHORT).show();
                }
            }
        });
                ...
                re.child(uid).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                        try {
                            ...
                            Toast.makeText(bDressMain.this, "No Link Found!", Toast.LENGTH_SHORT).show();
                        }
...
//        db.collection("bDress").document(uid).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
//            @Override
...
//        });
        ...
        StorageReference ImagesRefPP = storageRef.child("bDress/" + uid+"/" + "profile_Pic");
                    ...
                    re.child(uid).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                            ...
                            if (detail!=null){
                                ...
                                if (lati==0 && longi==0){
                                    Toast.makeText(bDressMain.this, "Cannot find any location", Toast.LENGTH_SHORT).show();
                                }else {
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(bDressMain.this);
        ...
        book.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(bDressMain.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                        ...
                        ref.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                                ...
                                if (detail!=null){
                                    ...
                                    if (date.isEmpty()){
                                        Toast.makeText(bDressMain.this, "Pick a Date", Toast.LENGTH_SHORT).show();
                                    }else {
                                        re.child(uid).child(String.valueOf(id+1)).setValue(req).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            @Override
                                            public void onComplete(@NonNull @NotNull Task<Void> task) {
                                                if (task.isSuccessful()){
                                                    Toast.makeText(bDressMain.this, "Request sent Successfully", Toast.LENGTH_SHORT).show();
                                                }else {
                                                    Toast.makeText(bDressMain.this, "Unsuccessful", Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        });
                                    }
