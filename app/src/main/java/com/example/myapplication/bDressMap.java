...
public class bDressMap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bdress_map);

        supportMapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.googlemap);

        client = LocationServices.getFusedLocationProviderClient(this);

        if (ActivityCompat.checkSelfPermission(bDressMap.this, Manifest.permission.ACCESS_FINE_LOCATION)
                == PackageManager.PERMISSION_GRANTED) {
            RealtimeLocation();
        } else {
            ActivityCompat.requestPermissions(bDressMap.this, new String[]
                                ...
                                public void onMapClick(@NonNull @NotNull LatLng latLng) {
                                    ...
                                    googleMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
                                        ...
                                        public boolean onMarkerClick(@NonNull @NotNull Marker marker) {
                                            try {
                                                Geocoder geocoder = new Geocoder(bDressMap.this, Locale.getDefault());
                                                ...
                                                Intent intent = new Intent(bDressMap.this, sellerbDressAccount.class);
