...
public class sellerHotelAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_hotel_account);
        ...
        StorageReference ImagesRefP1 = storageRef.child("hotel/" + userID+"/" + "package1");
        ...
        StorageReference ImagesRefP2 = storageRef.child("hotel/" + userID+"/" + "package2");
        ...
        StorageReference ImagesRefP3 = storageRef.child("hotel/" + userID+"/" + "package3");
        ...
        StorageReference ImagesRefW1 = storageRef.child("hotel/" + userID+"/" + "work1");
        ...
        StorageReference ImagesRefW2 = storageRef.child("hotel/" + userID+"/" + "work2");
        ...
        StorageReference ImagesRefW3 = storageRef.child("hotel/" + userID+"/" + "work3");
        ...
        StorageReference ImagesRefW4 = storageRef.child("hotel/" + userID+"/" + "work4");
        ...
        StorageReference ImagesRefW5 = storageRef.child("hotel/" + userID+"/" + "work5");
        ...
        re.child(uID).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull @NotNull DataSnapshot snapshot, @Nullable @org.jetbrains.annotations.Nullable String previousChildName) {
                ...
                Intent intent = new Intent(sellerHotelAccount.this, notification.class);
                PendingIntent pendingIntent = PendingIntent.getActivity(sellerHotelAccount.this, 0, intent, 0);

                Uri uri = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);

                String message = name + " wants to reserve a date on " + date;

                NotificationCompat.Builder builder = new NotificationCompat.Builder(sellerHotelAccount.this, "Dream Day");
...
//        });
        ...
        pf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(sellerHotelAccount.this, sellerHotelProfileEdit.class);
        ...
        current.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ActivityCompat.checkSelfPermission(sellerHotelAccount.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                    RealtimeLocation();
                } else {
                    ActivityCompat.requestPermissions(sellerHotelAccount.this, new String[]
        ...
        different.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(sellerHotelAccount.this, hotelMap.class);
                startActivity(intent);
                LocLayout.setVisibility(View.GONE);
            }
        });
...
//                startActivity(signInActivity);
                mAuth.signOut();
                Intent intent = new Intent(sellerHotelAccount.this, Login.class);
                startActivity(intent);
            }
        });
    }
                ...
                re.child(uID).child("starting_Price").setValue(startPrc).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull @NotNull Task<Void> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(sellerHotelAccount.this, "Price Updated", Toast.LENGTH_SHORT).show();
                        }
                        else {
                            Toast.makeText(sellerHotelAccount.this, "Error when Update Price", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }catch (Exception e){
    ...
    private void RealtimeLocation() {
        ...
        fusedLocationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
            ...
            public void onComplete(@NonNull @NotNull Task<Location> task) {
                ...
                if (location != null) {
                    try {
                        Geocoder geocoder = new Geocoder(sellerHotelAccount.this, Locale.getDefault());
    ...
    private void saveimgPckg1() {
        ...
        ImagesRefP1.putFile(imgUr).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ImagesRefP1.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        Toast.makeText(sellerHotelAccount.this, "Image Uploaded Successfully", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onFailure(@NonNull @NotNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(sellerHotelAccount.this, "Image Uploaded Unsuccessful", Toast.LENGTH_SHORT).show();
            }
