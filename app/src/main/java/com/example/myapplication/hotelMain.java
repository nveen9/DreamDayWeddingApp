...
public class hotelMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference re = FirebaseDatabase.getInstance().getReference("Hotel");
        ...
        hm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(hotelMain.this, firstHome.class);
        ...
        pf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(hotelMain.this, home.class);
                startActivity(intent);
            }
        });
        ...
        lo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mAuth.signOut();
                Intent intent = new Intent(hotelMain.this, Login.class);
                startActivity(intent);
            }
        });
        ...
        cll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Toast.makeText(hotelMain.this, "Invalid Number!", Toast.LENGTH_SHORT).show();
                }
            }
        });
                ...
                re.child(uid).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                        try {
                            ...
                            Toast.makeText(hotelMain.this, "No Link Found!", Toast.LENGTH_SHORT).show();
                        }
...
//        db.collection("Hotel").document(uid).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
//            @Override
...
//        });
        ...
        StorageReference ImagesRefPP = storageRef.child("hotel/" + uid+"/" + "profile_Pic");
                    ...
                    re.child(uid).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                            ...
                            if (detail!=null){
                                ...
                                if (lati==0 && longi==0){
                                    Toast.makeText(hotelMain.this, "Cannot find any location", Toast.LENGTH_SHORT).show();
                                }else {
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(hotelMain.this);
        ...
        book.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(hotelMain.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                        ...
                        ref.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                                ...
                                if (detail!=null){
                                    ...
                                    if (date.isEmpty()){
                                        Toast.makeText(hotelMain.this, "Pick a Date", Toast.LENGTH_SHORT).show();
                                    }else {
                                        re.child(uid).child(String.valueOf(id+1)).setValue(req).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            @Override
                                            public void onComplete(@NonNull @NotNull Task<Void> task) {
                                                if (task.isSuccessful()){
                                                    Toast.makeText(hotelMain.this, "Request sent Successfully", Toast.LENGTH_SHORT).show();
                                                }else {
                                                    Toast.makeText(hotelMain.this, "Unsuccessful", Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        });
                                    }
