...
public class hotelFirst extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hotel_first);
        ...
        hm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(hotelFirst.this, firstHome.class);
        ...
        pf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(hotelFirst.this, home.class);
                startActivity(intent);
            }
        });
        ...
        lo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mAuth.signOut();
                Intent intent = new Intent(hotelFirst.this, Login.class);
                startActivity(intent);
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (end.isEmpty()){
                    ...
                    try {
                        ...
                        databaseReference.orderByChild("starting_Price").startAt(starta).endAt(enda).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    ...
                                    Toast.makeText(hotelFirst.this, "Sorry, No results found that Price Range", Toast.LENGTH_SHORT).show();
                                }
                                adapter.notifyDataSetChanged();
                            }
                        ...
                        Toast.makeText(hotelFirst.this, "Invalid Number or Contain Letters", Toast.LENGTH_SHORT).show();
                    }
