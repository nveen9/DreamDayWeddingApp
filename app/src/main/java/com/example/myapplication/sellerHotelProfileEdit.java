...
public class sellerHotelProfileEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_hotel_profile_edit);
        ...
        StorageReference ImagesRefPP = storageRef.child("hotel/" + userID+"/" + "profile_Pic");
        ...
        re = FirebaseDatabase.getInstance().getReference("Hotel");
        uID = User.getUid();
        ...
        hm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(sellerHotelProfileEdit.this, sellerHotelAccount.class);
        ...
        nf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(sellerHotelProfileEdit.this, notification.class);
                startActivity(intent);
            }
        });
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mAuth = FirebaseAuth.getInstance();
                mAuth.signOut();
                Intent intent = new Intent(sellerHotelProfileEdit.this, Login.class);
                startActivity(intent);
            }
        });
...
//                    startActivity(intent);
//                }catch (Exception e){
//                    Toast.makeText(sellerHotelProfileEdit.this, "No Link Found!", Toast.LENGTH_SHORT).show();
//                }
//            }
//        });
            ...
            re.child(uID).child("business_Address").setValue(addr).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull @NotNull Task<Void> task) {
                    if (task.isSuccessful()){
                        Toast.makeText(sellerHotelProfileEdit.this, "Business Address Updated", Toast.LENGTH_SHORT).show();
                    }
                    else {
                        Toast.makeText(sellerHotelProfileEdit.this, "Error when Update Business Address", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    private void FirstUpdate() {
        ...
        if (firstName.isEmpty()){
            ...
            re.child(uID).child("business_Name").setValue(firstName).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull @NotNull Task<Void> task) {
                    if (task.isSuccessful()){
                        Toast.makeText(sellerHotelProfileEdit.this, "Business Name Updated", Toast.LENGTH_SHORT).show();
                    }
                    else {
                        Toast.makeText(sellerHotelProfileEdit.this, "Error when Update Business Name", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
                    ...
                    if (task.isSuccessful()){
                        re.child(uID).child("password").setValue(password).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull @NotNull Task<Void> task) {
                                if (task.isSuccessful()){
                                    mAuth.signOut();
                                    Toast.makeText(sellerHotelProfileEdit.this, "Password Updated Successfully", Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(sellerHotelProfileEdit.this,Login.class);
                                    startActivity(intent);
                                }
                                else {
                                    Toast.makeText(sellerHotelProfileEdit.this, "Error when Update Password", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
                ...
                public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                    if (snapshot.exists()){
                        ...
                        re.child(uID).child("mobile").setValue(mob).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull @NotNull Task<Void> task) {
                                if (task.isSuccessful()){
                                    Toast.makeText(sellerHotelProfileEdit.this, "Mobile Updated", Toast.LENGTH_SHORT).show();
                                }
                                else {
                                    Toast.makeText(sellerHotelProfileEdit.this, "Error when Mobiles Name", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
    ...
    private void wlinkUpdate() {
        ...
        re.child(uID).child("business_Link").setValue(wLink).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull @NotNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(sellerHotelProfileEdit.this, "Web Link Updated", Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(sellerHotelProfileEdit.this, "Error when Update Web Link", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void flinkUpdate() {
        ...
        re.child(uID).child("f_Link").setValue(fLink).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull @NotNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(sellerHotelProfileEdit.this, "Facebook Link Updated", Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(sellerHotelProfileEdit.this, "Error when Update Facebook Link", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void ilinkUpdate() {
        ...
        re.child(uID).child("i_Link").setValue(iLink).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull @NotNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(sellerHotelProfileEdit.this, "Instagram Link Updated", Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(sellerHotelProfileEdit.this, "Error when Update Instagram Link", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void ylinkUpdate() {
        ...
        re.child(uID).child("y_Link").setValue(yLink).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull @NotNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(sellerHotelProfileEdit.this, "Youtube Link Updated", Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(sellerHotelProfileEdit.this, "Error when Update Youtube Link", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void saveimg() {
        ...
        String userID = mAuth.getCurrentUser().getUid();
        StorageReference storageRef = FirebaseStorage.getInstance().getReference();
        StorageReference ImagesRef = storageRef.child("hotel/" + userID+"/" + "profile_Pic");
        ...
        ImagesRef.putFile(imgUr).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ImagesRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        Toast.makeText(sellerHotelProfileEdit.this, "Image Uploaded Successfully", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(sellerHotelProfileEdit.this,sellerHotelAccount.class);
                        startActivity(intent);
                    }
                });
            ...
            public void onFailure(@NonNull @NotNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(sellerHotelProfileEdit.this, "Image Uploaded Unsuccessful", Toast.LENGTH_SHORT).show();
            }
